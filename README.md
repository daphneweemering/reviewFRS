...
| scripts    | Contains analysis scripts:<br> • [`clean.CEF.R`](scripts/0.clean.CEF.R) – Cleans data from the Ceftriaxone ALS trial.<br> • [`clean.RT001.R`](scripts/0.clean.RT001.R) – Cleans data from the RT001 ALS trial.<br> • [`TE.R`](scripts/1.TE.R) – Simulates permuted treatment assignment and adds treatment effects.<br> • [`studyadj.R`](scripts/2.studyadj.R) – Adjusts data for study-based modifications.<br> • [`perm.CEF.R`](scripts/3.perm.CEF.R) – Fits models to the simulated Ceftriaxone ALS trial data.<br> • [`perm.RT001.R`](scripts/3.perm.RT001.R) – Fits models to the simulated RT001 ALS trial data.<br> • [`sim.JM.R`](scripts/4.sim.JM.R) – Simulates data and fits models using the joint modeling framework. |
